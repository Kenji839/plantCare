    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.plantCount}>You have {plants.length} Plants</Text>
        </View>
            ...
            upcomingTasks.map((task) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  onPress={() => navigation.navigate('PlantDetail', { plantId: task.plantId })}
                >
                  <Text style={styles.taskIcon}>{getTaskIcon(task.type)}</Text>
                  <View style={styles.taskContent}>
                    <Text style={styles.taskTitle}>{task.title}</Text>
                    {plant && <Text style={styles.taskPlant}>{plant.name}</Text>}
                  </View>
                  <Text style={[
                    styles.taskDays,
